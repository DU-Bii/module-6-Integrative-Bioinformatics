...
- Practical with R
  ...
  - Document containing R code for the TP, together with explanations and output graphs can be here: [Network_Inference_with_WGCNA.r](session6/Network Inference with WGCNA.r)
